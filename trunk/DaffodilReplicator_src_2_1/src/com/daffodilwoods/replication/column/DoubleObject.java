...
public class DoubleObject extends AbstractColumnObject
{
    ...
    public DoubleObject(int sqlType0,AbstractDataBaseHandler abstractDBHandler0)
    {
        sqlType = sqlType0;
...
//             os.write("<![CDATA[" + rowValue.toString() + "]]>");
            os.write(rowValue.toString() );
             ...
             os.write(EncoderDecoder.escapeUnicodeString1(rowValue.toString(), true));
