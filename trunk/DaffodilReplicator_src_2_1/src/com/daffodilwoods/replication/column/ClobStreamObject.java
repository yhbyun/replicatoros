...
/**
 * As ClassCast was occuring when setClob was done in oracle ,so we have kept new oracleClobObject
 *This class is also used by postgresql as no clob data was coming from oracle to postgresql
 */
public class ClobStreamObject extends AbstractColumnObject
{
    ...
    public ClobStreamObject(int sqlType0,AbstractDataBaseHandler abstractDBHandler0)
    {
//      System.out.println("OracleClobObject.OracleClobObject(sqlType0)");
        sqlType = sqlType0;
...
//System.out.println(" start = "+start+" length = "+length);
        ...
        {
          RClob rclob = new RClob(start, length);
          InputStream inputstream = rclob.getAsciiStream();
          InputStreamReader reader = new InputStreamReader(inputstream);
          try {
            pst.setCharacterStream(index, reader, inputstream.available());
          }
