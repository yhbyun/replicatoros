...
public class XMLElement
{
    ...
    String encodingAttValue;
    String attValue;
//  for each table its unique;
    HashMap columnTypes;

    public XMLElement(String elementName0)
    {
        elementList = new ArrayList();
        elementName = elementName0;
//    System.out.println("XMLElement.XMLElement(elementName0) elementName ="+elementName);
    }
    ...
    public void addEncodeAtt(String value)
       {
//      System.out.println("XMLElement.addAtt(value) value ="+value);
           encodingAttValue = value;
       }
...
//System.out.println(" CHECK ENCODING ---------------encodingAttValue :"+encodingAttValue);
        if(encodingAttValue != null && encodingAttValue.equalsIgnoreCase("y")){
//        System.out.println("att value "+ attValue);
//        System.out.println(" elementValue ="+elementValue);
          if(elementValue.length()== 4 && elementValue.equalsIgnoreCase("null"))
            return;
          elementValue = EncoderDecoder.decodeNew(elementValue);
