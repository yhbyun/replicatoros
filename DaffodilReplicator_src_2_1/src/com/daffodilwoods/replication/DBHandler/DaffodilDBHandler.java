...
public class DaffodilDBHandler
    extends AbstractDataBaseHandler  {

  private String daff_publication_TableName;
  private String daff_subscription_TableName;
  private String daff_bookmark_TableName;
  private String daff_rep_TableName;
  private String daff_log_Table;
  private String daff_schedule_Table;
  private String daff_ignoredColumns_Table;
  private String daff_trackReplicationTablesUpdation_Table;
  private String daff_trackPrimaryKeyUpdation_Table = "Rep_trackPrimaryKey";
  protected static Logger log = Logger.getLogger(DaffodilDBHandler.class.
                                                 getName());

  public DaffodilDBHandler() {}

  public DaffodilDBHandler(ConnectionPool connectionPool0) {
    connectionPool = connectionPool0;
    vendorType = Utility.DataBase_DaffodilDB;
    daff_publication_TableName = "users." + publication_TableName;
    daff_subscription_TableName = "users." + subscription_TableName;
    daff_bookmark_TableName = "users." + bookmark_TableName;
    daff_rep_TableName = "users." + rep_TableName;
    daff_log_Table = "users." + log_Table;
    daff_schedule_Table = "users." + Schedule_TableName;
    daff_ignoredColumns_Table = "users." + ignoredColumns_Table;
    daff_trackReplicationTablesUpdation_Table = "users." +trackReplicationTablesUpdation_Table;
    daff_trackPrimaryKeyUpdation_Table ="users."+trackPrimaryKeyUpdation_Table;
  ...
  protected void createSuperLogTable(String pubName) throws SQLException,
    ...
    logTableQuery.append(" Create Table ")
        .append(daff_log_Table)
        .append(" ( " + RepConstants.logTable_commonId1 +
                " long autoincrement , " + RepConstants.logTable_tableName2 +
                "  varchar(255) ) ");
...
//System.out.println(" Create Index on LogTable : "+indexQuery.toString());
  ...
  /*  protected void createRepTable(String pubName) throws SQLException,
        RepException
    {
        ...
        repTableQuery.append(" Create Table ").append(getRepTableName())
            .append("(  "+RepConstants.repTable_pubsubName1+"  varchar(255) , "+RepConstants.repTable_tableId2+"  int autoincrement, ")
  ...
  protected void createRepTable(String pubName) throws SQLException,
    ...
    repTableQuery.append(" Create Table ").append(getRepTableName()).append(
        ...
        .append(RepConstants.repTable_tableId2).append("  int autoincrement, ")
  ...
  public void createShadowTable(String pubsubName, String tableName,
    ...
    shadowTableQuery.append(" Create Table ")
        ...
        .append(" ( " + RepConstants.shadow_sync_id1 +
                "  long autoincrement , ")
        .append("   " + RepConstants.shadow_common_id2 + "  long , ")
...
//    String[] colNames = (String[]) columnTypeInfoMap.keySet().toArray(new String[0]);
    ...
    updTriggerQuery.append(" Create trigger ")
        ...
        .append(" begin declare maxlogid long; declare pkchanged char(1); ").append(insertLogTable)
        .append(" Select max(" + RepConstants.logTable_commonId1 +
                ") into maxlogid from ")
        .append(daff_log_Table).append("; ")
        //-------------
        .append(" if( ");
...
//  public String getDataType(int sqlType, String typeName) {
//    switch (sqlType) {
//      case Types.BIT 		:      return "boolean";// //-7;
//      case Types.TINYINT 	:      return "tinyint";// //-6;
//      case Types.SMALLINT	:      return "smallint";// // 5;
//      case Types.INTEGER 	:      return "int";// // 4;
//      case Types.BIGINT 	:      return "long";// //-5;
//      case Types.FLOAT 		:      return "float";// // 6;
//      case Types.REAL 		:      return "real";// // 7;
//      case Types.DOUBLE 	:      return "double precision";// // 8;
//      case Types.NUMERIC 	:      return "numeric";// // 2;
//      case Types.DECIMAL	:      return "decimal";// // 3;
//      case Types.CHAR		:      return "char";// // 1;
//      case Types.VARCHAR 	:      return "varchar";// //12;
//      case Types.LONGVARCHAR 	:      return "long varchar";// //-1;
//      case Types.DATE 		:      return "date";// //91;
//      case Types.TIME 		:      return "time";// //92;
//      case Types.TIMESTAMP 	:      return "timestamp";// //93;
//      case Types.BINARY		:      return "binary";// //-2;
//      case Types.VARBINARY 	:      return "varbinary";// //-3;
//      case Types.LONGVARBINARY 	:      return "long varbinary";// //-4;
//      case Types.JAVA_OBJECT    :      return "long varbinary";//2000;
//      case Types.BLOB           :      return "blob";//2004;
//      case Types.CLOB           :      return "clob";//2005;
//
//      case Types.REF            :      return "clob";//2006;
//      case Types.NULL		:      return "";// // 0;
//      case Types.OTHER		:      return "clob";//1111;
//      case Types.DISTINCT       :      return "";//2001;
//      case Types.STRUCT         :      return "";//2002;
//      case Types.ARRAY          :      return "";//2003;
//      case Types.DATALINK       :      return "";//70;
  ...
  public void setTypeInfo(TypeInfo typeInfo, ResultSet rs) throws RepException,
    ...
    switch (typeInfo.getSqlType()) {
      ...
      case Types.BIT:
        ...
        //case Types.BIT 		:      typeInfo.setTypeName("boolean");break;// //-7;
      case Types.TINYINT:
        ...
        typeInfo.setSqlType(Types.SMALLINT);
      ...
      case Types.NUMERIC:
        ...
        break; // // 2;
      case Types.DECIMAL: // typeInfo.setTypeName("decimal");break;// // 3;
        ...
        break; // // 3;
//       typeInfo.setTypeName("float");break;// // 8;
      case Types.CHAR:
        if (isColumnSizeExceedMaximumSize(typeInfo)) {
...
// RepPrinter.print(" DaffodilDBHandler typeInfo = " + typeInfo);
    switch (sqlType) {
      ...
      case 2004: // blob
      case -2: // binary
//        Latest change by sachin - march 04    added
...
//          case -4: // long varbiary
  ...
  public String getPublicationTableName() {
    return daff_publication_TableName;
  }

  public String getSubscriptionTableName() {
    return daff_subscription_TableName;
  }

  public String getRepTableName() {
    return daff_rep_TableName;
  }

  public String getLogTableName() {
    return daff_log_Table;
  }

  public String getBookMarkTableName() {
    return daff_bookmark_TableName;
  }
...
// System.out.println("DaffodilDB Handler  = "+ex.getErrorCode()+"  ex.getMessage() = "+ex.getMessage());
    if (ex.getMessage().indexOf("PRIMARY KEY") != -1 ||
        ex.getErrorCode() == 1276 || ex.getErrorCode() == 1275 ||
        ex.getMessage().indexOf("Constraint Violation") != -1) {
      return true;
    }
...
// System.out.println(" createIndexQuery : "+createIndexQuery.toString());
  ...
  public String getIgnoredColumns_Table() {
    return daff_ignoredColumns_Table;
  }

  public String getTrackReplicationTablesUpdation_Table() {
    return daff_trackReplicationTablesUpdation_Table;
  }

  public String getTrackPrimayKeyUpdation_Table() {
      return daff_trackPrimaryKeyUpdation_Table;
    }
...
//System.out.println("DaffodilDBHandler makePrimaryPreperedStatementDelete  ::  " +query.toString());
  ...
  /**
   * isSchemaSupported
   * DaffodilDB supoort the schema so it return true
   * @return boolean
   */
