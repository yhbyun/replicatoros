...
import com.daffodilwoods.replication.DBHandler.OracleHandler;

public class TimeStampObject extends AbstractColumnObject
{
     ...
     * @param sqlType0
     */
    public TimeStampObject(int sqlType0,AbstractDataBaseHandler abstractDBHandler0)
    {
    ...
    {
        String value = element.elementValue.trim();
                            ...
                            String columnName,ArrayList encodedCols) throws SQLException, IOException
    {
        ...
        try {
           newObject = rows.getObject(index);
            ...
            newObject = new Timestamp(0000,00,00,00,00,00,0);
        }
        ...
        try {
          oldObject = oldResultSet.getObject(index);
            ...
            oldObject = new Timestamp(0000,00,00,00,00,00,0);
        }
...
//      return Timestamp.valueOf(value);
    ...
    {
try {
//       if(abstractDBHandler instanceof OracleHandler)
  return row.getTimestamp(index);
//      return row.getObject(index);
}
catch (SQLException ex) {
   return new Timestamp(0000,00,00,00,00,00,0);
}
    }
}
