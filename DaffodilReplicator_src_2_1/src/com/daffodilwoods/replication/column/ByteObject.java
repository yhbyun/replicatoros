...
public class ByteObject extends AbstractColumnObject
{
     ...
     * @param sqlType0
     */
    public ByteObject(int sqlType0,AbstractDataBaseHandler abstractDBHandler0)
    {
        sqlType = sqlType0;
                                ...
                                int index) throws SQLException
    {
        ...
        {
            pst.setByte(index, Byte.parseByte(value));
        }
    }
        ...
        SQLException, IOException
    {
        try
        {
          if (!encodedCols.contains(col.toUpperCase())) {
            ...
            os.write("<![CDATA[" +EncoderDecoder.escapeUnicodeString1(getObject(rs, index).toString(), true) + "]]>");
          }
